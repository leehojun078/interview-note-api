...
class PromptBuilder(
    ...
    fun getCategoriesForJobField(jobField: String): List<String> {
        return when (jobField) {
            ...
            else -> listOf("직무역량", "문제해결", "협업능력")  // 기본값
        }
    }

    // ===== Phase 7B: 실시간 채팅 면접용 프롬프트 =====
     ...
     * 종합 평가 프롬프트
     *
     * Phase 7: 면접 종료 시 종합 평가 생성
     */
    /**
     * 종합 평가 프롬프트 생성 (Phase 8A 개선: 예시 기반 + 질문 유도)
     *
     * 최적화 방안:
     * - 방안 3 (Few-Shot Learning): 실제 500-700자 예시 제공
     * - 방안 2 (Question-Driven): 7가지 질문으로 구체적 답변 유도
     */
